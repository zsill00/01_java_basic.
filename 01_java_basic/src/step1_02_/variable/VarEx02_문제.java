...
public class VarEx02_문제 {
	...
	public static void main(String[] args) {
		...
		int salary =  100;
		int dusqhd = salary *12;
		double tprma = dusqhd /10.0;
		double chd = dusqhd  - tprma;
		
		System.out.println("연봉 = " + chd +"원");
		...
		int wjatn = 50;
		int angus = 4;
		int snrn = tlgja + wjatn + angus;
		double dmdel = snrn /3.0;
		
		System.out.println("평균 = " +  dmdel  + "점");
